...
sub backprop {
  ...
  my $grad_last_activate_outputs_to_softmax_cost_func = SPVM::MyAIUtil->softmax_cross_entropy_cost_derivative(SPVM::new_float_array($last_activate_outputs), SPVM::new_float_array($desired_outputs))->to_elems;
